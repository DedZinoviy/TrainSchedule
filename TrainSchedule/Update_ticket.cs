...
namespace TrainSchedule
{
    public partial class Update_ticket : Form
    {
        ...
        public Update_ticket(TrainSchedule schedule, long id_for_update)
        {
            Schedule = schedule;
        ...
        private void Update_ticket_Load(object sender, EventArgs e)
        {
        ...
        private void Save_btn_Click(object sender, EventArgs e)
        {
            ...
            serv.UpdateTicket(updateId, trainId, seatId, pasId, cost, avail); // Добавить сущность билета в БД.
            Schedule.UpdateTicket();
